<main class="container">
        ...
        <p><?php $dataNascimento = new DateTime($animal['datanasci']);
              echo $this->lang->line('BirthDate').': '.$dataNascimento->format('d/m/Y'); ?></p>

        <div class="form-outline mb-4">
            <label for="genero"><?php echo $this->lang->line('Gender'); ?>:</label>
        ...
        <div class="form-outline mb-4">
            <label for="raca"><?php echo $this->lang->line('Breed'); ?>:</label>
        ...
        <div class="form-outline mb-4">
            <label for="porte"><?php echo $this->lang->line('Size'); ?>:</label>
                ...
                <?php foreach ($portes as $porte): 
                    if($porte['id_porte'] == $animal['id_porte']){ ?>
                        <option value="<?php echo $porte['id_porte']; ?>" selected><?php echo $porte['porte']; ?></option>
                    <?php } else {?>
        ...
        <div class="form-outline mb-4">
            <label for="pelagem"><?php echo $this->lang->line('Coat'); ?>:</label>
                ...
                <?php foreach ($pelagens as $pelagem): 
                    if($pelagem['id_pelagem'] == $animal['id_pelagem']){ ?>
                        <option value="<?php echo $pelagem['id_pelagem'];?>" selected><?php echo $pelagem['pelagem']; ?></option>
                    <?php } else {?>
        ...
        <div class="form-outline mb-4">
            <label for="porte"><?php echo $this->lang->line('Temperament'); ?></label>
                ...
                <?php foreach ($temperamentos as $temperamento): 
                    if($temperamento['id_temperamento'] == $animal['id_temperamento']){ ?>
                        <option value="<?php echo $temperamento['id_temperamento']; ?>" selected><?php echo $temperamento['temperamento']; ?></option>
                    <?php } else { ?>
