                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                <div class="container-fluid">
                                        <a class="navbar-brand" href="/">
                                                <img class="img-responsive" src="<?php  echo base_url('assets/img/logo.jpeg');?>">
                                        </a>
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                                <ul class="navbar-nav">
                                                        ...
                                                        <li class="nav-item">
                                                                <a class="nav-link" href="<?php if($logged) echo site_url('usuarios/application'); else echo site_url('usuarios/register'); ?>"><?php echo $this->lang->line('PftMatch'); ?></a>
                                                        </li>
                                                </ul>
                                        </div>
                                        <a href="<?php echo site_url('languageSwitcher/switchLang/english'); ?>"><i class="flag flag-us"></i></a>&nbsp;
                                        <a href="<?php echo site_url('languageSwitcher/switchLang/portuguese'); ?>"><i class="flag flag-brazil"></i></a>&nbsp;
                                                ...
                                                if(!$logged) {
                                                        ...
                                                        "<ul class='navbar-nav'>
                                                                <li class='nav-item dropdown'>
                                                                        ...
                                                                        <li><a class='dropdown-item' href='".site_url('usuarios/logout')."'>".$this->lang->line("Logout")."&nbsp;<i class='bi bi-box-arrow-in-right'></i></a></li>                                                                        </ul>
                                                                </li>
                                                        </ul>";
                                                ?>
                                </div>
