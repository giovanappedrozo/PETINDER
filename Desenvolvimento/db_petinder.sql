...
(DEFAULT, 'Média', 'pt_BR'),
(DEFAULT, 'Longa', 'pt_BR'),   
(DEFAULT, 'Sem pelos', 'pt_BR'),
(DEFAULT, 'Short', 'en_US'),
(DEFAULT, 'Medium', 'en_US'),
(DEFAULT, 'Long', 'en_US'),   
(DEFAULT, 'Hairless', 'en_US');
...
(DEFAULT, 'Medroso', 'pt_BR'),
(DEFAULT, 'Agressivo', 'pt_BR'),
(DEFAULT, 'Assustado', 'pt_BR'),   
(DEFAULT, 'Tranquilo', 'pt_BR'),
(DEFAULT, 'Agitado', 'pt_BR'),
(DEFAULT, 'Preguiçoso', 'pt_BR'),
(DEFAULT, 'Curioso', 'pt_BR'),   
(DEFAULT, 'Afetuoso', 'pt_BR'),
(DEFAULT, 'Fearful', 'en_US'),
(DEFAULT, 'Agressive', 'en_US'),
(DEFAULT, 'Scared', 'en_US'),   
(DEFAULT, 'Calm', 'en_US'),
(DEFAULT, 'Agitated', 'en_US'),
(DEFAULT, 'Lazy', 'en_US'),
(DEFAULT, 'Curious', 'en_US'),   
(DEFAULT, 'Loving', 'en_US');

CREATE TABLE IF NOT EXISTS outrosAnimais (
        id_outrosAnimais SERIAL PRIMARY KEY,
        outrosAnimais VARCHAR(70),
        lang CHAR(5)
);

INSERT INTO outrosAnimais VALUES 
(DEFAULT, 'Sim. Em minha casa não vive nenhum outro animal.', 'pt_BR'),
(DEFAULT, 'Não. Em minha casa já vive outro animal doméstico (gato ou cachorro).', 'pt_BR'),
(DEFAULT, 'Não. Em minha casa já vive outro animal, mas não doméstico.', 'pt_BR'),   
(DEFAULT, 'Yes. No other animal lives in my house', 'en_US'),
(DEFAULT, 'No. Another domestic animal already lives in my house', 'en_US'),
(DEFAULT, 'No. Another exotic animal already lives in my house', 'en_US');
