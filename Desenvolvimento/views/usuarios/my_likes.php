<main class="container">
        ...
        <ul class="nav nav-tabs">
                <li class="nav-item">
                        <a class="nav-link active" href="<?php echo site_url('usuarios/mi-au-doreis'); ?>">MI-AU-DOREIS</a>
                </li>
                <li class="nav-item">
                        <a class="nav-link" href="<?php echo site_url('usuarios/des-au-gosteis'); ?>">DES-AU-GOSTEIS</a>
                </li>
        </ul>
        <?php if($animais){
