...
\newglossaryentry{Log}{
    name=log,
    description={Processo de registro de eventos relevantes num sistema computacional.}
}

\newglossaryentry{Tinder}{
    name=Tinder,
    description={Aplicativo de relacionamento social baseado em combinações (\textit{“matches”}).}
}

\newglossaryentry{Latexdiff}{
    name=latexdiff,
    description={Ferramenta que permite gerar um documento indicando as diferenças entre duas versões de um documento \LaTeX.}
}
